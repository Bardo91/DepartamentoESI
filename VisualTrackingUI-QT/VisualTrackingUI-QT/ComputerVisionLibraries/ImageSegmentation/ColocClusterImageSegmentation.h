...
namespace vision {
	...
	namespace segmentation {
		...
		int ColorClusterImageSegmentation(cv::Mat& frame1, cv::Mat& frame2, ColorClusterSpace& CS, unsigned int threshold, std::vector<SimpleObject>& objects1, std::vector<SimpleObject>& objects2);
