...
namespace vision{
	namespace tracking{
		...
		void RobustStereoMatching::init(double _speed){
			...
			//Speed determine the speed of the matching algorithm. the higher it's setted, the more sensible is the algorithm to both tracking objects and noise.
			speed = _speed; 
		...
		//--------------------------------------------------------------------
		SimpleObject RobustStereoMatching::getObject(int _i) const{
			return objects[_i];
		}
		...
		//--------------------------------------------------------------------
		bool RobustStereoMatching::isUpdated(unsigned int i) const {
			return updated[i];
		}
